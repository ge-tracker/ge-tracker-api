...
var APIUptimeWrapper = function () {
    function APIUptimeWrapper(client) {
...
var AuthWrapper = function () {
    ...
    createClass(AuthWrapper, [{
        ...
        value: function _wrapPost(path) {
            ...
            return this.client.post(path, params).then(function (_ref) {
                var data = _ref.data;
                return data;
            });
        }
...
var BarrowsRepairWrapper = function () {
    function BarrowsRepairWrapper(client) {
...
var DashboardWrapper = function () {
    function DashboardWrapper(client) {
...
var DecantPotionsWrapper = function () {
    function DecantPotionsWrapper(client) {
...
var DeviceWrapper = function () {
    function DeviceWrapper(client) {
...
var FavouriteItemsWrapper = function () {
    function FavouriteItemsWrapper(client) {
    ...
    createClass(FavouriteItemsWrapper, [{
        ...
        key: "_wrapPost",
        value: function _wrapPost(path, params) {
...
var GELimitsWrapper = function () {
    function GELimitsWrapper(client) {
...
var GraphWrapper = function () {
    ...
    createClass(GraphWrapper, [{
        key: '_wrapGet',
        value: function _wrapGet(path) {
            var apiUrl = this.client.defaults.baseURL.replace('/api', '');
            return this.client.get(apiUrl + 'graph/' + path).then(function (_ref) {
                var data = _ref.data;
                return data;
            }).then(handleResponseBody);
        }
...
var HerbloreWrapper = function () {
    function HerbloreWrapper(client) {
...
var HighAlchemyWrapper = function () {
    function HighAlchemyWrapper(client) {
...
var HighVolumeWrapper = function () {
    function HighVolumeWrapper(client) {
...
var HighestMarginsWrapper = function () {
    function HighestMarginsWrapper(client) {
...
var ItemSetsWrapper = function () {
    function ItemSetsWrapper(client) {
...
var ItemsWrapper = function () {
    function ItemsWrapper(client) {
...
var LeaderboardWrapper = function () {
    function LeaderboardWrapper(client) {
...
var MagicTabletsWrapper = function () {
    function MagicTabletsWrapper(client) {
...
var MarketWatchWrapper = function () {
    function MarketWatchWrapper(client) {
...
var NewItemsWrapper = function () {
    function NewItemsWrapper(client) {
...
var NotificationsWrapper = function () {
    function NotificationsWrapper(client) {
...
var ProfitTrackerWrapper = function () {
    function ProfitTrackerWrapper(client) {
...
var PlankMakingWrapper = function () {
    function PlankMakingWrapper(client) {
...
var RSUpdatesWrapper = function () {
    function RSUpdatesWrapper(client) {
...
var StoreProfitWrapper = function () {
    function StoreProfitWrapper(client) {
...
var SubscriptionsWrapper = function () {
    function SubscriptionsWrapper(client) {
...
var SuggestedItemsWrapper = function () {
    function SuggestedItemsWrapper(client) {
...
var TanLeatherWrapper = function () {
    function TanLeatherWrapper(client) {

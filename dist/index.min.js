...
var BillingWrapper = function (_APIBaseWrapper) {
    ...
    createClass(BillingWrapper, [{
        ...
        value: function updateSession(sessionId, state) {
            var data = (typeof state === 'undefined' ? 'undefined' : _typeof(state)) === 'object' ? state : { state: state };
...
var CombinationItemsWrapper = function (_APIBaseWrapper) {
    inherits(CombinationItemsWrapper, _APIBaseWrapper);

    function CombinationItemsWrapper() {
        classCallCheck(this, CombinationItemsWrapper);
        return possibleConstructorReturn(this, (CombinationItemsWrapper.__proto__ || Object.getPrototypeOf(CombinationItemsWrapper)).apply(this, arguments));
    }

    createClass(CombinationItemsWrapper, [{
        key: 'getItems',
        value: function getItems() {
...
function createClient(apiKey) {
    ...
    var instance = Axios__default.create(merge(options, { headers: createAuthHeader(apiKey) }));
